...
//        Non primitives are usually objects that we create (the exception being String)
  ...
  //        double > float > long > int > short > byte
        ...
        // byte numbers1=135;  this will give error because its out of byte range
        byte number2=-23;
        ...
        //  int       4 bytes       Stores whole numbers -2,147 483,648 to 2,147 483,648

        int i1=123134;
        System.out.println(i1);
        // int i2= 200000000; out of range

        System.out.println("35"); //his is text
        System.out.println(35);  // this is actual number

        //// As a default java  picks int for whole number

        //  Long     8 bytes  8 Stores whole numbers from -9,223,372,036,854,775,808 to 9,223,372,036,775,,808
         long l1=2000;
         long l2=2000000000;
